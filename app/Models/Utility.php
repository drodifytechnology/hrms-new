...
<body dir="ltr">
    ...
    <div style="color: inherit;" id="x_appendonsend"></div>
    <div style="background-color: rgb(244, 246, 248); margin: 0px;">
        <div style="background-color: rgb(255, 255, 255); margin: auto; border-radius: 8px; max-width: 600px;">
            <div
                style="text-align: center; background-color: rgb(5, 5, 5); padding: 20px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
                <img alt="Drodify Logo" id="x_image_0" width="129" height="40" style="width: 129px; height: 40px;"
                    src="https://drodifytechnology.com/assets/images/templates/navbar/logo-d.png">
            </div>
            <div style="padding: 30px 20px 10px;">
                ...
                <div class="elementToProof"
                    style="text-align: center; margin: 5px 0px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 16px; color: rgb(44, 62, 80);">
                    <span style="font-weight: 600;">Welcome to {app_name}.</span>
                </div>
            </div>
            <div style="padding: 20px;">

                <div style="background-color: rgb(249, 249, 249); margin-top: 20px; padding: 20px; border-radius: 6px;">
                    <h3 class="elementToProof" style="margin-top: 0px; margin-bottom: 0px;">
                        <span
                            style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: rgb(51, 51, 51);"></span>
                    </h3>
                    <div class="elementToProof"
                        style="margin-top: 1em; margin-bottom: 1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12pt; color: rgb(51, 51, 51);">
                <p>Hello,&nbsp;<br />Welcome to {app_name}.</p>
                    <p><strong>You are now user..</strong></p>
                    <p><strong>Email </strong>: {email}<br /><strong>Password</strong> : {password}</p>
                    <p>{app_url}</p>
                    <p>Thanks,<br />{app_name}</p>  </div>
                </div>
                <center style="color: inherit;">
                    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: rgb(51, 51, 51);">
                        <br><br>
                    </div>
                </center>
            ...
            <div
                style="text-align: center; background-color: rgb(236, 240, 241); padding: 15px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12px; color: rgb(127, 140, 141);">
                © 2025 Drodify Technology Pvt. Ltd. | support@drodifytechnology.com | www.drodifytechnology.com
            </div>
        </div>
    </div>
</body>
        ...
        <div style="background-color: rgb(255, 255, 255); margin: auto; border-radius: 8px; max-width: 600px;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="background-color: rgb(249, 249, 249); margin-top: 20px; padding: 20px; border-radius: 6px;">
                    ...
                    <div class="elementToProof"
                        style="margin-top: 1em; margin-bottom: 1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12pt; color: rgb(51, 51, 51);">
                    <p>Hello {employee_name},&nbsp;<br />Welcome to {app_name}.</p>
        ...
        <div style="background-color: rgb(255, 255, 255); margin: auto; border-radius: 8px; max-width: 600px;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="background-color: rgb(249, 249, 249); margin-top: 20px; padding: 20px; border-radius: 6px;">
                    ...
                    <div class="elementToProof"
                        style="margin-top: 1em; margin-bottom: 1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12pt; color: rgb(51, 51, 51);">
                        <p><strong>Subject</strong>:-HR department/Company to send payslips by email at time of confirmation of payslip</p>
                    <p>Hi {name},</p>
                    ...
                    <p><span style="color: #000000; font-family: "Open Sans", sans-serif; font-size: 14px; background-color: #ffffff;">{<strong>app_name</strong>}</span></p></div>
                </div>
                <center style="color: inherit;">
                    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: rgb(51, 51, 51);">
                        <br><br>
        ...
        <div style="background-color: rgb(255, 255, 255); margin: auto; border-radius: 8px; max-width: 600px;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="background-color: rgb(249, 249, 249); margin-top: 20px; padding: 20px; border-radius: 6px;">
                    ...
                    <div class="elementToProof"
                        style="margin-top: 1em; margin-bottom: 1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12pt; color: rgb(51, 51, 51);"><p ><b>Subject:-HR department/Company to send ticket for {ticket_title}</b></p>
        ...
        <div style="background-color: rgb(255, 255, 255); margin: auto; border-radius: 8px; max-width: 600px;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="background-color: rgb(249, 249, 249); margin-top: 20px; padding: 20px; border-radius: 6px;">
                    ...
                    <div class="elementToProof"
                        style="margin-top: 1em; margin-bottom: 1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12pt; color: rgb(51, 51, 51);"><p ><b>Subject:-HR department/Company to send award letter to recognize an employee</b></p>
        ...
        <div style="background-color: rgb(255, 255, 255); margin: auto; border-radius: 8px; max-width: 600px;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="background-color: rgb(249, 249, 249); margin-top: 20px; padding: 20px; border-radius: 6px;">
                    ...
                    <div class="elementToProof"
                        style="margin-top: 1em; margin-bottom: 1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12pt; color: rgb(51, 51, 51);"> <p ><b>Subject:-HR department/Company to send transfer letter to be issued to an employee from one location to another.</b></p>
        ...
        <div style="background-color: rgb(255, 255, 255); margin: auto; border-radius: 8px; max-width: 600px;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="background-color: rgb(249, 249, 249); margin-top: 20px; padding: 20px; border-radius: 6px;">
                    ...
                    <div class="elementToProof"
                        style="margin-top: 1em; margin-bottom: 1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12pt; color: rgb(51, 51, 51);"><p ><b>Subject:-HR department/Company to send resignation letter .</b></p>
        ...
        <div style="background-color: rgb(255, 255, 255); margin: auto; border-radius: 8px; max-width: 600px;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="background-color: rgb(249, 249, 249); margin-top: 20px; padding: 20px; border-radius: 6px;">
                    ...
                    <div class="elementToProof"
                        style="margin-top: 1em; margin-bottom: 1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12pt; color: rgb(51, 51, 51);"><p><strong>Subject:-HR department/Company to send trip letter .</strong></p>
                    ...
                    <p><strong>Regards,</strong></p>
                    <p><strong>HR Department,</strong></p>
                    <p><strong>{app_name}</strong></p></div>
                </div>
                <center style="color: inherit;">
                    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: rgb(51, 51, 51);">
                        <br><br>
        ...
        <div style="background-color: rgb(255, 255, 255); margin: auto; border-radius: 8px; max-width: 600px;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="background-color: rgb(249, 249, 249); margin-top: 20px; padding: 20px; border-radius: 6px;">
                    ...
                    <div class="elementToProof"
                        style="margin-top: 1em; margin-bottom: 1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12pt; color: rgb(51, 51, 51);"><p>&nbsp;</p>
        ...
        <div style="background-color: rgb(255, 255, 255); margin: auto; border-radius: 8px; max-width: 600px;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="background-color: rgb(249, 249, 249); margin-top: 20px; padding: 20px; border-radius: 6px;">
                    ...
                    <div class="elementToProof"
                        style="margin-top: 1em; margin-bottom: 1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12pt; color: rgb(51, 51, 51);"><p><strong>Subject:-HR department/Company to send complaints letter.</strong></p>
        ...
        <div style="background-color: rgb(255, 255, 255); margin: auto; border-radius: 8px; max-width: 600px;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="background-color: rgb(249, 249, 249); margin-top: 20px; padding: 20px; border-radius: 6px;">
                    ...
                    <div class="elementToProof"
                        style="margin-top: 1em; margin-bottom: 1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12pt; color: rgb(51, 51, 51);">
                        <p><strong>Subject:-HR department/Company to send warning letter.</strong></p>
        ...
        <div style="background-color: rgb(255, 255, 255); margin: auto; border-radius: 8px; max-width: 600px;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="background-color: rgb(249, 249, 249); margin-top: 20px; padding: 20px; border-radius: 6px;">
                    ...
                    <div class="elementToProof"
                        style="margin-top: 1em; margin-bottom: 1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12pt; color: rgb(51, 51, 51);"><p><strong>Subject:-HR department/Company to send termination letter.</strong></p>
        ...
        <div style="background-color: rgb(255, 255, 255); margin: auto; border-radius: 8px; max-width: 600px;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="background-color: rgb(249, 249, 249); margin-top: 20px; padding: 20px; border-radius: 6px;">
                    ...
                    <div class="elementToProof"
                        style="margin-top: 1em; margin-bottom: 1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12pt; color: rgb(51, 51, 51);">
                        <p><strong>Subject:-HR department/Company to send approval letter to {leave_status} a vacation or leave.</strong></p>
        ...
        <div style="background-color: rgb(255, 255, 255); margin: auto; border-radius: 8px; max-width: 600px;">
            ...
            <div style="padding: 20px;">
                ...
                <div style="background-color: rgb(249, 249, 249); margin-top: 20px; padding: 20px; border-radius: 6px;">
                    ...
                    <div class="elementToProof"
                        style="margin-top: 1em; margin-bottom: 1em; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12pt; color: rgb(51, 51, 51);"><p><span style="font-family: sans-serif;"><strong>Hi </strong>{contract_employee} </span></p>
            ...
            'new_leave_request' => [
                ...
                'lang' => [
                    ...
                    <p><span style="font-family: sans-serif;">{ company_name }</span></p></div>
                </div>
                <center style="color: inherit;">
                    <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color: rgb(51, 51, 51);">
                        <br><br>
