...
<?php endif; ?>
                                        ...
                                        <div class="text-xs mt-1">
                                            <?php echo e(__('Create branch.')); ?> <a href="<?php echo e(route('branch.index')); ?>"><b><?php echo e(__('Click here')); ?></b></a>
                                       </div>
...
<?php endif; ?>
                                    ...
                                    <div class="text-xs mt-1">
                                        <?php echo e(__('Create department.')); ?> <a href="<?php echo e(route('department.index')); ?>"><b><?php echo e(__('Click here')); ?></b></a>
                                   </div>
                                </div>
                                    <div class="form-group col-md-6">
...
<?php endif; ?>
                                        ...
                                        <div class="text-xs mt-1">
                                            <?php echo e(__('Create designation.')); ?> <a href="<?php echo e(route('designation.index')); ?>"><b><?php echo e(__('Click here')); ?></b></a>
                                       </div>
                                    </div>
                        ...
                        <div class="card em-card">
                            ...
                            <div class="card-body employee-detail-create-body">
                                <?php if($documents->count() == 0): ?>
                                    <div class="text-danger"><?php echo e(__('Please first add document')); ?><a href="<?php echo e(route('document.index')); ?>"
                                            target="_blank"><?php echo e(__(' here')); ?></a>.</div>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\hrms\resources\views/employee/create.blade.php ENDPATH**/ ?>