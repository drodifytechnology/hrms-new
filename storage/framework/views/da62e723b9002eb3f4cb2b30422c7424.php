                                    ...
                                    <div class="col-auto mb-3 mb-sm-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                ...
                                                <h6 class="m-0"><a
                                                        href="<?php echo e(route('user.index')); ?>"><?php echo e(__('Staff')); ?></a></h6>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-auto mb-3 mb-sm-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                <small class="text-muted"><?php echo e(__('Total')); ?></small>
                                                <h6 class="m-0"><a
                                                        href="<?php echo e(route('ticket.index')); ?>"><?php echo e(__('Ticket')); ?></a></h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-auto text-end">
                                    ...
                                    <div class="col-auto mb-3 mb-sm-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                <small class="text-muted"><?php echo e(__('Total')); ?></small>
                                                <h6 class="m-0"><a
                                                        href="<?php echo e(route('accountlist.index')); ?>"><?php echo e(__('Account Balance')); ?></a>
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-auto mb-3 mb-sm-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <small class="text-muted"><?php echo e(__('Total')); ?></small>
                                        <h6 class="m-0"><a href="<?php echo e(route('job.index')); ?>"><?php echo e(__('Jobs')); ?></a>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-auto mb-3 mb-sm-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <small class="text-muted"><?php echo e(__('Total')); ?></small>
                                        <h6 class="m-0"><a
                                            href="<?php echo e(route('job.index')); ?>"><?php echo e(__('Active Jobs')); ?></a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto text-end">
                            ...
                            <div class="col-auto mb-3 mb-sm-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <small class="text-muted"><?php echo e(__('Total')); ?></small>
                                        <h6 class="m-0"><a
                                                href="<?php echo e(route('job.index')); ?>"><?php echo e(__('Inactive Jobs')); ?></a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto text-end">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\hrms\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>