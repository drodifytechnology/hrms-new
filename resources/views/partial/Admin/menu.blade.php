...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
        <ul class="dash-navbar">
            ...
            <!-- employee-->
            @if (Gate::check('Tasks') )
               <li class="dash-item {{ Request::segment(1) == 'intern' ? 'active' : '' }}">
            ...
            @if (Gate::check('View assigned interns') )
               ...
               <li class="dash-item {{ Request::segment(1) == 'task-activity' ? 'active' : '' }}">
                    <a href="{{ route('intern-asign-task') }}"
                        class="dash-link"><span class="dash-micon"><i class="ti ti-user"></i></span><span
            ...
            <!-- internship -->
            @if (Gate::check('Internship'))
                
                    <li class="dash-item {{ Request::segment(1) == 'internships' ? 'active' : '' }}">
