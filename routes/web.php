...
Route::group(
  ...
  Route::resource('internships', InternshipController::class)->middleware(
        [
            'auth',
            'XSS',
        ]
 ...
 Route::middleware(['auth', 'web'])->group(function () {
    ...
    Route::get('/documents', [InternController::class, 'documents'])->name('intern.documents');
    Route::get('/certificate', [InternController::class, 'downloadCertificate'])->name('intern.certificate');
